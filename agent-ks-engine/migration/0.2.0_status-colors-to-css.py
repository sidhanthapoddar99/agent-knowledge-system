...
USAGE
-----
    python3 agent-ks-engine/migration/0.2.0_status-colors-to-css.py detect  [--root .]
    python3 agent-ks-engine/migration/0.2.0_status-colors-to-css.py migrate [--root .] [--dry-run]
    python3 agent-ks-engine/migration/0.2.0_status-colors-to-css.py verify  [--root .]
