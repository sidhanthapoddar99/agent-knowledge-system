...
| [`180`](./180_rendered-link-check-belongs-to-this-repo.md) | the rendering gate is in the wrong tree | ✅ **Done 2026-08-04.** `scripts/checks/check-links.mjs` crawls a live server, is control-tested both directions, and gives a correct distinct answer in dev (4), preview (4) and a real static host (546) |
