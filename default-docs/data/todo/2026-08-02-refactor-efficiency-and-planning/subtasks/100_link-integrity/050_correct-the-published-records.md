...
- The published note: `agent-ks-engine/release-notes/0.2.1.md` — tag `v0.2.1`
...
- [x] `agent-ks-engine/release-notes/0.2.1.md:79` — "All 101 are now root-relative. The section reads
...
`agent-ks-engine/release-notes/0.2.1.md` carries a dated `[!CAUTION]` correction block rather than a
...
| Record | Claim | Truth |
|---|---|---|
| `agent-ks-engine/release-notes/0.2.1.md:79` | "All 101 are now root-relative" | Reverted. They are relative again |
| `agent-ks-engine/release-notes/0.2.1.md:72` | "Every relative link in the issues user-guide was a 404 — all 85" | **True**, and still true — the renderer is unfixed |
...
**The original job was done on 2026-08-03** — `agent-ks-engine/release-notes/0.2.1.md` carries a dated
