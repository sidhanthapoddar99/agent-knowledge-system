...
The ordering prefix (`NN_`/`NNN_`) is **stripped from the URL slug** — same as docs (see the `documentation-guide` skill's `references/layouts/docs-layout.md`). `subtasks/020_implementation/010_backend.md` → `…/subtasks/implementation/backend`.
