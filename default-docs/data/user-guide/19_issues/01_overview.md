...
Agents working with the tracker should invoke the `documentation-guide` skill — its `references/issue-layout.md` is the canonical agent-facing companion to this page.
