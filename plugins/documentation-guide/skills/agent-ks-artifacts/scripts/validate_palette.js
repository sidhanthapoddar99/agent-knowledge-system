/*
 * ─────────────────────────────────────────────────────────────────────────────
 * PROVENANCE — bundled verbatim, NOT rewritten.
 *
 * This validator is carried AS-IS from the Claude Code built-in "dataviz" skill
 * (Claude Code v2.1.202, captured 2026-07-07). It is the one deliberate exception
 * to this skill's rewrite-don't-paste stance: it is a functional tool (code), not
 * prose. A functionally identical, stdlib-only Python twin (validate_palette.py)
 * exists upstream but is intentionally NOT bundled — this repo runs bun/node and
 * the JS below covers both the CLI and the in-page (<script type="module">) mode.
 *
 * Full provenance + upstream-sync protocol: ../references/PROVENANCE.md
 * (which points at the issue's notes/01_skill-sources-and-provenance.md).
 * ─────────────────────────────────────────────────────────────────────────────
 */
/**
