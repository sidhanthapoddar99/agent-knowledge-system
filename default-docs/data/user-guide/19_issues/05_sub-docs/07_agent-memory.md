...
| Holds | Does not hold |
|---|---|
| What is **true and binding** for this issue | **Decisions.** Those are the issue's [Notes](./04_notes.md) |
| **How we got here** — what was tried, what landed, what was parked | **The plan.** Order is [Plans](./09_plans.md) |
...
([Plans](./09_plans.md)) — one click away in the sidebar, where plans list in plain
...
- [Plans](./09_plans.md) — what's left, in what order, and who's blocked
- [Agent Log](./05_agent-log.md) — what happened (vs what's still true)
- [Subtasks](./03_subtasks.md) — the source of truth for detail
- [Notes](./04_notes.md) — the decisions; same free-form feel, different owner and durability
