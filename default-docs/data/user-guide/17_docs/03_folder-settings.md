...
| `allow_diagram_pages` | `boolean` | No | `true` | **Section root only.** Set `false` to stop `.mmd`/`.dot`/`.excalidraw` files rendering as [first-class pages](../15_writing-content/06_diagram-pages.md) in this section |
