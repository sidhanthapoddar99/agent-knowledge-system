...
- [ ] Lifecycle section: the 4 categories with their 7 statuses (one line each —
...
- [ ] Mention that filters/tabs are category-level and the badge shows the status.
- [ ] Remove any assignees-as-in-progress phrasing and any 4-state /
      `closed`/`cancelled` remnants.
- [ ] Keep it a thin map — depth stays in the user-guide / skill. Ideally import
