...
install, the banner still names which tree it read, and `agent-ks-engine/release-notes/0.2.1.md` no
...
- The published record to correct: `agent-ks-engine/release-notes/0.2.1.md`
...
- [x] **Correct `agent-ks-engine/release-notes/0.2.1.md`** — dated correction block, not a rewrite
