...
- [ ] Repository Layout tree: add root `migration/` with a one-line description.
- [ ] Key Architecture Concepts: a short "Version contract" paragraph —
...
- [ ] Key Rules: add the gate as a numbered rule (site.yaml `engine_version`
