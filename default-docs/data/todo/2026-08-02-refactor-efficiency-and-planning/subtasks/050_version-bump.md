...
- [x] Write the release note and set the tag convention (new this round —
      [`agent-ks-engine/release-notes/`](../../../../../agent-ks-engine/release-notes/README.md))
...
byte-identical to `agent-ks-engine/release-notes/0.2.0.md`. The three retro ones were published with
