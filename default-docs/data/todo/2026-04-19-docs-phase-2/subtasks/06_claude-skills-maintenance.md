...
- [x] ~~`issues` — Claude skill for navigating the issue tracker (scope lives in `2025-06-25-claude-skills/subtasks/02_issues-skill.md`)~~ — folded into `agent-ks-issues`; the page documents this explicitly.
