...
const NEW_ROUND_FLAGS = [
  ...
  { name: 'goal', value: 'text', desc: 'the lead line: why this round exists; also the note beside the 00_index.md entry' },
  { name: 'inputs', value: 'a,b', desc: 'comma-separated paths, each written under `## Links` as a link with the file title as text' },
...
export const MANIFEST = [
  ...
  },
  {
    ...
    summary: 'Add a round file flat in an agent log from templates/log-round.md and list it in 00_index.md (10, 20, 30; --report writes 21–29)',
