...
- [x] `git mv` the three scripts from
...
- [x] Sweep both skill trees for old migration paths/names
...
- [x] Mirror everything to the installed cache (including deleting its
